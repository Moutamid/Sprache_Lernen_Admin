...
public class ExerciseAdapters extends RecyclerView.Adapter<ExerciseAdapters.ContentVH> {

    Context context;
    ArrayList<ExerciseModel> list;

    public ExerciseAdapters(Context context, ArrayList<ExerciseModel> list) {
        ...
        holder.delete.setOnClickListener(v -> {
            new MaterialAlertDialogBuilder(context)
                    ...
                    .setPositiveButton("Yes", ((dialog, which) -> {
                        ...
                        Constants.databaseReference().child(name).child(Constants.EXERCISE).child(model.getID()).removeValue()
